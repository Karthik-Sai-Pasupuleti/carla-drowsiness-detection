...
def collect_carla_data(world):
    ...
    return steering_angle, lateral_offset
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            steering_angle, lane_pos = collect_carla_data(world)

            steering_array.append(steering_angle)
            lane_position_array.append(lane_pos)
            # Check if 2 seconds have passed
            if time.time() - last_collection_time >= 2.0:
                print("Steering angles over last 2 seconds:", steering_array)
                print("Lane positions over last 2 seconds:", lane_position_array)

                # Clear for next window
                steering_array.clear()
                lane_position_array.clear()
                last_collection_time = time.time()
