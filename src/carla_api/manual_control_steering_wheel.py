...
def game_loop(args, shared_data):
    pygame.init()
    pygame.font.init()
    world = None
    ...
    try:
        ...
        while True:
            ...
            steering_angle, lane_positon = collect_carla_data(world)
            shared_data["vehicle_data"].append(
                (current_time, steering_angle, lane_positon)
            )
...
def carla_steering_wheel(shared_data):
...
if __name__ == "__main__":
    ...
    carla_steering_wheel(shared_data_)
